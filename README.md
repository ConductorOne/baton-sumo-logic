...
# `baton-sumo-logic` [![Go Reference](https://pkg.go.dev/badge/github.com/conductorone/baton-sumo-logic.svg)](https://pkg.go.dev/github.com/conductorone/baton-sumo-logic) ![ci](https://github.com/conductorone/baton-sumo-logic/actions/workflows/ci.yaml/badge.svg) ![verify](https://github.com/conductorone/baton-sumo-logic/actions/workflows/verify.yaml/badge.svg)
...
- `minimal-access-role-name`: Name of the low-privilege role to assign when a user's last role is revoked (default: "Analyst")
...
Flags:
      ...
      --minimal-access-role-name string Name of the fallback role assigned when revoking a user’s last role ($BATON_MINIMAL_ACCESS_ROLE_NAME) (default "Analyst")
