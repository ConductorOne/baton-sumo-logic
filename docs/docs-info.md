...
- Minimal Access Role Name (Optional) – Display name of the low-privilege role that should be automatically assigned to a user when their last role is revoked during provisioning operations (Default is Analyst)
